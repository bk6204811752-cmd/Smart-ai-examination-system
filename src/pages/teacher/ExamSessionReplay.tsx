        ...
        <div className="bg-white rounded-xl shadow-lg p-6">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-6">
              ...
              <div className="text-center">
                <div className="text-2xl font-bold text-blue-600">{Math.floor(session.duration / 60)}m</div>
            ...
            <div className="bg-white rounded-xl shadow-lg overflow-hidden">
              ...
              <div className="relative bg-gray-900 aspect-video">
                ...
                <div className="absolute top-4 right-4 space-y-2">
                  <div className="bg-black/80 backdrop-blur-sm rounded-lg px-4 py-2">
                    <div className="text-white text-center">
                      <div className={`text-2xl font-bold ${
                        frame.metrics.risk_score >= 70 ? 'text-red-400' :
                        frame.metrics.risk_score >= 50 ? 'text-yellow-400' :
                        'text-green-400'
                      }`}>
                  ...
                  <div className="bg-black/80 backdrop-blur-sm rounded-lg px-4 py-2">
                    <div className="text-white text-center">
                      <div className="text-lg font-bold">{Math.round(frame.metrics.attention_score)}%</div>
              ...
              <div className="bg-gray-800 p-4">
                ...
                <div className="mb-4">
                  ...
                  <div className="flex justify-between text-xs text-gray-400 mt-1">
                    ...
                    <span>Frame {currentFrame + 1} / {session.frames.length}</span>
                  </div>
                </div>
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-xs text-gray-500">
                          {new Date(event.timestamp).toLocaleTimeString()} • Frame {event.frameIndex + 1}
                        </p>
                      </div>
                    </div>
                  </button>
              ...
              <div className="space-y-4">
                <div>
                  <div className="flex justify-between text-sm mb-2">
                    ...
                    <span className="font-bold text-gray-900">{Math.round(frame.metrics.attention_score)}%</span>
                  </div>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    <div className="bg-gray-100 rounded-lg p-2">
                      ...
                      <div className="text-sm font-bold">{frame.metrics.gaze_horizontal.toFixed(1)}°</div>
                    </div>
                    <div className="bg-gray-100 rounded-lg p-2">
                      <div className="text-xs text-gray-600">Vertical</div>
                      <div className="text-sm font-bold">{frame.metrics.gaze_vertical.toFixed(1)}°</div>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="bg-red-50 border border-red-200 rounded-lg p-3">
                    ...
                    <div className="mt-2 space-y-1">
                      {frame.metrics.violations.map((v, i) => (
                        <div key={i} className="text-xs text-red-600">{v}</div>
                      ))}
                    </div>
                  </div>
                )}
              ...
              <div className="space-y-3 text-sm">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-medium text-orange-600">
                    {Math.round(session.frames.reduce((sum, f) => sum + f.metrics.risk_score, 0) / session.frames.length)}
                  </span>
                </div>
              </div>
            </div>
